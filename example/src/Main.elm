...
import Example.Render.Text as Render exposing (..)
import Example.Render.Text as Text exposing (spec)
import Example.Render.Image as Render exposing (..)
import Example.Render.Image as Image exposing (spec)
...
import Example.Plane.Impl.Text exposing (TextPlane)
import Example.Plane.Impl.Text as Text exposing (toGrid)
